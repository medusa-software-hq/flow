...
data class CandidateIssue(
    ...
    /**
     * The `Priority` Issue Field's selected option name (e.g. `"Urgent"`), or `null` if unset or if
     * the field read degraded (see [GitHubAppCandidateClient]). Read by [IssuePriority].
     */

...
| `FLOW_WORKER_ENGINE` | Optional: `builtin` (default), `claude`, or `leader`. Which engine this worker runs an unspecified-engine session on — see [`docs/engines.md`](../docs/engines.md#the-leaderassistant-engine--cloud-opt-in-m3-11). |

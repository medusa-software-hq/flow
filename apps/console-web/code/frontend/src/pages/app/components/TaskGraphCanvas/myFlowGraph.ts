...
import type { TAnyTaskGraph } from '@/app/session_workspace/task_graph/ITaskGraph';
import { TaskNode, taskNodeTag } from './TaskNode';
...
export interface UseMyFlowGraphArgs {
  readonly sessionLive: TAnyTaskGraph;
...
export function useMyFlowGraph(args: UseMyFlowGraphArgs): readonly [MyNode[], MyEdge[]] {
  ...
  const sessionSnap: TAnyTaskGraph = useSnapshot(sessionLive);
